...
/// Persistent gray-flow state: the committed route, the cached/pending WebView
/// URLs (secure storage), the cache expiry and the push-invite bookkeeping.
class CoopVault {
  static const String _routeKey = 'chr.paddock.route';
  static const String _expiryKey = 'chr.paddock.expiry';
  static const String _inviteKey = 'chr.paddock.invite.after';
  static const String _permissionKey = 'chr.paddock.push.allowed';
  static const String _osDeniedKey = 'chr.paddock.push.os_denied';
  static const String _savedUrlKey = 'chr.paddock.secure.destination';
  static const String _pendingUrlKey = 'chr.paddock.secure.pending';
  ...
  CoopPath get route => CoopPath.parse(_preferences.getString(_routeKey));

  Future<void> saveRoute(CoopPath route) =>
