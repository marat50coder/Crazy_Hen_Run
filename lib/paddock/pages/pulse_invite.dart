...
/// mode. Accept → system dialog; Skip → snoozed for [CoopConfig.pushSnoozeSeconds].
...
class _PulseInviteState extends State<PulseInvite> {
  ...
  void initState() {
    ...
    // The boot gate locks portrait before routing here; re-enable landscape so
    // this screen rotates with the device (matches the WebView).
...
class _PledgeButton extends StatelessWidget {
  const _PledgeButton({
    required this.width,
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: emphasized
                ? const <Color>[Color(0xFF7BDA6E), Color(0xFF1F8E4A)]
                : const <Color>[Color(0xFF4FB98C), Color(0xFF20735A)],
